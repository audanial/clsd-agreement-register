...
return [
    ...
    */
    ...
    // CLSD: emoji is off on purpose (LP0 / S20 decision). Livewire components are
    // emoji-free single-file components under resources/views/livewire/, keeping
    // resources/views/components/ for anonymous Blade components only. The emoji is
    // NOT required by the resolver — Finder::normalizeName() strips it, and
    // Finder::resolveSingleFileComponentPath() falls back to plain filenames.
    'make_command' => [
